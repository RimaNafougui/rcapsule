...
export default function AdminCatalogueEditPage({
  params,
}: {
  ...
  if (!product) {
    return (
      <div className="space-y-4">
        ...
        <Button as={NextLink} href="/admin/catalogue" variant="flat">
          Back to catalogue
        </Button>
      </div>
    );
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center gap-3">
        <Button as={NextLink} href="/admin/catalogue" size="sm" variant="flat">
          ← Catalogue
        </Button>
        <h1 className="font-display font-light text-2xl tracking-tight">
          Edit Product
        </h1>
      </div>
      ...
      <Card>
        <CardHeader>
          <h2 className="font-display font-light text-base tracking-tight">
            Core Info
          </h2>
        </CardHeader>
        <CardBody>
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="pt-2 border-t border-divider">
              <p className="eyebrow text-default-400 mb-3">Images & Links</p>
            ...
            {/* Additional Details */}
            <div className="pt-2 border-t border-divider">
              <p className="eyebrow text-default-400 mb-3">
                Additional Details
              </p>
              <div className="space-y-3">
                <Select
