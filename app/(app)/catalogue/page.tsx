...
import AddToClosetModal from "@/components/catalogue/AddToClosetModal";
...
export default function CataloguePage() {
  ...
  const { data, isLoading } = useSWR<CatalogueResponse>(apiUrl, fetcher, {
