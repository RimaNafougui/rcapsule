...
export const clothesPostSchema = z.object({
  ...
  placesToWear: z.array(z.string()).nullable().optional(),
  materials: z.string().nullable().optional(),
  description: z.string().nullable().optional(),
  condition: z.string().nullable().optional(),
  globalproductid: z.string().nullable().optional(),
  purchaseDate: z.string().nullable().optional(),
  wardrobeIds: z.array(z.string()).nullable().optional(),
  careInstructions: z.string().nullable().optional(),
  sustainability: z.string().nullable().optional(),
  ...
  originalPrice: z.union([z.number(), z.string(), z.null()]).optional(),
